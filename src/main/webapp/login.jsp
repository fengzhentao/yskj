...
<head>
    ...
    <script src="${pageContext.request.contentType}/static/bootstrap3/js/jquery-1.11.2.min.js"></script>
    <STYLE>
        body{
            background: #ebebeb;
...
<form action="${pageContext.request.contextPath}/adminUser/login.html" method="post" onsubmit="return checkForm()">
    <DIV style="background: rgb(255, 255, 255); margin: -100px auto auto; border: 1px solid rgb(231, 231, 231); border-image: none; width: 400px; height: 200px; text-align: center;">
        ...
        <P style="padding: 30px 0px 10px; position: relative;">
            ...
            <INPUT id="phone" name="phone" class="ipt" type="text" placeholder="请输入手机号" value="${adminUser.phone }">
        </P>
        <P style="position: relative;">
            <SPAN class="p_logo"></SPAN>
            <INPUT id="passWord" name="passWord" class="ipt"  type="password" placeholder="请输入密码" value="${adminUser.passWord }">
        </P>
