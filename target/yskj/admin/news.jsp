    ...
    <script type="text/javascript">
        ...
        function deleteBlog(){
            ...
            $.messager.confirm("系统提示","您确定要删除这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
                if(r){
                    $.post("${pageContext.request.contextPath}/rt/delete.html",{ids:ids},function(result){
                        if(result.success){
        ...
        function openBlogModifyTab(){
            ...
            if(selectedRows.length!=1){
                $.messager.alert("系统提示","请选择一个要修改的信息！");
                return;
            }
            var row=selectedRows[0];
            window.parent.openTab('修改信息','modifyNews.jsp?id='+row.newsId,'icon-writeblog');
        }
    </script>
</head>
...
<table id="dg" title="用户管理管理" class="easyui-datagrid"
       ...
       url="${pageContext.request.contextPath}/rt/list.html" fit="true" toolbar="#tb">
    <thead>
    <tr>
        <th field="cb" checkbox="true" align="center"></th>
        <th field="newsId" width="20" align="center">编号</th>
        <th field="newsName" width="20" align="center">标题</th>
        <th field="newTypeName" width="20" align="center">所属类型</th>
